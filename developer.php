...
<section class="grey">
    <div class="grid">
        <div class="two-thirds">
            ...
            <p><a class="read-more" href="https://wiki.gnome.org/Projects/Vala">Learn More about Vala</a><a class="read-more" href="http://valadoc.org/">Library Documentation for Vala</a></p>
        </div>
    </div>
</section>
<?php
