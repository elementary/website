...
if (count($cart) > 0) {
    ...
    <form action="<?php echo $page['lang-root'] ?>store/checkout" method="post" class="grid grid--narrow">
            ...
            foreach ($cart as $index => $item) {
                ...
                <div class="list__item" id="product-<?php echo $index ?>">
                    ...
                    <div class="list__info">
                        ...
                        <span><a
                                href="store/inventory?math=set&quantity=0&id=<?php echo $id[0] ?>&variant=<?php echo $id[1] ?>">Remove</a></span>
                    </div>
                    <div class="list__detail">
                        ...
                        <div class="subtotal">
                            ...
                            <span>×</span>
                            <input type="number" min="0" max="9999" step="1" value="<?php echo $item['quantity'] ?>"
                                   name="product-<?php echo $index ?>-quantity">
                            <span>=</span>
        ...
        <div class="whole grid grid--address">
            ...
            <label>Address</label>
            <input type="text" name="address1" placeholder="Street Address, P.O. Box, Company Name"
                   autocomplete="shipping address-line1" required>
            <label>Address 2</label>
            <input type="text" name="address2" placeholder="Apartment, Suite, Unit, Building, Floor"
