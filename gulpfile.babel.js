...
gulp.task('svg', () => {
    ...
    const src = [
        ...
        '_images/icons/actions/48/view-refresh.svg',
        ...
        '_images/icons/apps/48/accessories-calculator.svg',
        '_images/icons/apps/48/accessories-camera.svg',
        '_images/icons/apps/48/accessories-text-editor.svg',
        '_images/icons/apps/48/accessories-screenshot.svg',
        '_images/icons/apps/48/application-default-icon.svg',
        '_images/icons/apps/48/internet-mail.svg',
        '_images/icons/apps/48/internet-web-browser.svg',
        '_images/icons/apps/48/multimedia-audio-player.svg',
        '_images/icons/apps/48/multimedia-photo-manager.svg',
        '_images/icons/apps/48/multimedia-video-player.svg',
        '_images/icons/apps/48/office-calendar.svg',
        '_images/icons/apps/48/preferences-desktop.svg',
        '_images/icons/apps/48/ubiquity.svg',
        '_images/icons/apps/48/utilities-terminal.svg',
        '_images/icons/apps/48/system-file-manager.svg',
        '_images/icons/apps/48/system-software-install.svg',
        ...
        '_images/icons/categories/48/applications-graphics.svg',
        '_images/icons/categories/48/applications-interfacedesign.svg',
        ...
        '_images/icons/mimes/48/text-html.svg',
