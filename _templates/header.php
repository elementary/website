        ...
        <nav>
            <div class="nav-content">
                ...
                <ul class="right">
                    ...
                    <li><a href="https://elementarycommunity.slack.com/join/shared_invite/enQtMjg3NTExNDIwOTQ1LWExZjEzZGE4YjY4MjUwMTQ1MTVjZDJlNTFhNGRlN2FmZmUxNjhmZTI1YmNmZjQ0ODMxYzcwZTI1OTVlMTQyNWI" target="_blank" rel="noopener" data-l10n-off title="Slack"><i class="fa fa-slack-hash"></i></a></li>
                </ul>
            </div>
        </nav>
