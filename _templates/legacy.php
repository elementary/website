...
if (getenv('PHPENV') === 'production' && $is_HTTP) {
    ...
    <div id="legacy-warning">
        ...
        <p>Your browser is not taking advantage of HTTPS connections. Some parts of this site will not work properly.
            Please <a href="http://browsehappy.com/">upgrade</a> to an alternative web browser.</p>
...
<?php } else {
    if ($is_old_IE) { ?>
        <div id="legacy-warning">
            ...
            <p>This version of Internet Explorer is out of date and may contain bugs or security vulnerabilities. Please
                <a href="http://browsehappy.com/">upgrade</a> to edge or an alternative web browser.</p>
            <div id="legacy-warning-buttons">
                <a href="#" onClick="document.getElementById('legacy-warning').style.display = 'none';">Dismiss</a>
