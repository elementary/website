...
?>
                ...
                <div class="clear row">
                    ...
                    <div class="text-center">
                        <div id="creating-a-usb-choices" class="column linked">
                            ...
                            <a class="button creating-a-usb-on-osx" href="#creating-a-usb-on-others">OS X</a>
			    <a class="button creating-a-usb-on-others" href="#creating-a-usb-on-others">Ubuntu</a>
                        </div>
                    </div>
			...
			<img src="images/installation/osx_dialog.png">
