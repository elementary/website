            ...
            <div id="burning-a-cd" class="slide">
                ...
                <div class="text-center">
                    <div id="burning-choices" class="column linked">
                        ...
                        <a class="button burning-on-macos" href="#burning-on-macos">OS X</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div id="burning-on-macos" class="slide">
                        ...
                        <img src="images/installation/macos_dialog.png" alt="CD dialog on OS X">

                        <p>Right click (or control click) on elementaryOS.iso and select "Burn elementaryOS.iso to Disc...".</p>

                        <img src="images/installation/macos_menu.png" alt="CD dialog on OS X">
