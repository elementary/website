...
<div class="grid">
    <div class="two-thirds">
        ...
        <h4>The elementary OS platform is built upon a strong foundation of Free &amp; Open Source software. Without
            projects such as these, elementary OS would not exist.</h4>
    </div>
    <div class="half">
        <h3>Security &amp; Privacy</h3>
        <p>By being Open Source, elementary OS can benefit from superior security and privacy over closed source
            software. When the source code is available to audit, anyone in the community — whether a security
            researcher, a concerned user, or an OEM shipping the OS on their hardware — can ensure the software is
            secure and not collecting or leaking personal information.</p>
    </div>
    <div class="half">
        <h3>Better for Developers</h3>
        <p>If your app could benefit from a system API or feature that’s not yet available, you can help write that
            feature into the OS. Similarly, you might be curious as to how a feature or design pattern in elementary OS
            was made. Instead of guessing or trying to reimplement it on your own, you can just look at the underlying
            source code for a definitive answer.</p>
    </div>
...
<div class="grid">
    <div class="platform-item full">
        ...
        <div>
            <a class="button sub-item" href="https://github.com/elementary/calendar" target="_blank"
               rel="noopener"><span>Calendar</span></a>
            ...
            <a class="button sub-item" href="https://github.com/elementary/scratch" target="_blank"
               rel="noopener"><span>Scratch</span></a>
            <a class="button sub-item" href="https://github.com/elementary/terminal" target="_blank"
               rel="noopener"><span>Terminal</span></a>
    ...
    <div class="platform-item half">
        <a href="get-involved#desktop-development">
            <img class="oss-logo" src="images/icons/categories/64/preferences-desktop-wallpaper.svg"
                 alt="Desktop Shell">
            <p class="oss-title">Pantheon Desktop Shell</p>
        </a>
        <div>
            <a class="button sub-item" href="https://github.com/elementary/stylesheet" target="_blank"
               rel="noopener"><span>GTK+ Stylesheet</span></a>
            ...
            <a class="button sub-item" href="https://launchpad.net/plank" target="_blank"
               rel="noopener"><span>Plank</span></a>
            <a class="button sub-item" href="https://github.com/elementary/applications-menu" target="_blank"
               rel="noopener"><span>Slingshot</span></a>
            <a class="button sub-item" href="https://github.com/elementary/switchboard" target="_blank"
               rel="noopener"><span>Switchboard</span></a>
            <a class="button sub-item" href="https://github.com/elementary/wingpanel" target="_blank"
               rel="noopener"><span>Wingpanel</span></a>
        </div>
    </div>
    <div class="platform-item half">
        <a href="get-involved#desktop-development">
        ...
        <div>
            <a class="button sub-item" href="https://github.com/elementary/contractor" target="_blank"
               rel="noopener"><span>Contractor</span></a>
            <a class="button sub-item" href="https://github.com/elementary/granite" target="_blank"
               rel="noopener"><span>Granite</span></a>
            <a class="button sub-item" href="https://github.com/elementary/capnet-assist" target="_blank"
               rel="noopener"><span>Captive Portal Assistant</span></a>
            <a class="button sub-item" href="https://launchpad.net/pantheon-online-accounts" target="_blank"
               rel="noopener"><span>Pantheon Online Accounts</span></a>
            <a class="button sub-item" href="https://github.com/elementary/pantheon-agent-polkit" target="_blank"
               rel="noopener"><span>Polkit Agent</span></a>
        </div>
    </div>
    ...
    <div class="platform-item third" id="ubuntu">
        ...
        <div>
            <a class="button sub-item" href="https://launchpad.net/ayatana" target="_blank"
               rel="noopener"><span>Ayatana</span></a>
            <a class="button sub-item" href="https://launchpad.net/bamf" target="_blank"
               rel="noopener"><span>BAMF</span></a>
    ...
    <div class="platform-item third" id="gtk">
        ...
        <div>
            ...
            <a class="button sub-item" href="http://www.pango.org/" target="_blank"
               rel="noopener"><span>Pango</span></a>
            <a class="button sub-item" href="https://cairographics.org/" target="_blank"
               rel="noopener"><span>Cairo</span></a>
        </div>
    </div>
    <div class="platform-item third" id="gnome">
        ...
        <div>
            <a class="button sub-item" href="https://wiki.gnome.org/Projects/dconf" target="_blank"
               rel="noopener"><span>dconf</span></a>
            <a class="button sub-item" href="https://wiki.gnome.org/Projects/GLib" target="_blank" rel="noopener"><span>GLib</span></a>
            <a class="button sub-item" href="https://wiki.gnome.org/Projects/PolicyKit" target="_blank"
               rel="noopener"><span>PolicyKit</span></a>
    ...
    <div class="platform-item two-thirds" id="fdo">
        ...
        <div>
            <a class="button sub-item" href="https://www.freedesktop.org/wiki/Software/dbus/" target="_blank"
               rel="noopener"><span>D-Bus</span></a>
            <a class="button sub-item" href="https://gstreamer.freedesktop.org/" target="_blank" rel="noopener"><span>GStreamer</span></a>
            <a class="button sub-item" href="https://www.freedesktop.org/wiki/Software/libinput/" target="_blank"
               rel="noopener"><span>libinput</span></a>
            <a class="button sub-item" href="https://www.freedesktop.org/wiki/Software/LightDM/" target="_blank"
               rel="noopener"><span>LightDM</span></a>
            <a class="button sub-item" href="https://www.freedesktop.org/wiki/Software/PulseAudio/" target="_blank"
               rel="noopener"><span>PulseAudio</span></a>
            <a class="button sub-item" href="https://www.freedesktop.org/wiki/Software/systemd/" target="_blank"
               rel="noopener"><span>systemd</span></a>
        </div>
    </div>
    ...
    <div class="platform-item half" id="gnu">
        ...
        <div>
            ...
            <a class="button sub-item" href="https://www.gnu.org/software/gcc/" target="_blank"
               rel="noopener"><span>GCC</span></a>
            <a class="button sub-item" href="https://www.gnu.org/software/libc/" target="_blank" rel="noopener"><span>GNU C Library</span></a>
            <a class="button sub-item" href="https://www.gnu.org/software/coreutils/" target="_blank"
               rel="noopener"><span>Coreutils</span></a>
        </div>
    </div>
...
<div class="grid">
    <div class="whole">
        <div class="two-thirds">
            ...
            <p>elementary makes a point to send funds back to the projects we rely on. When you purchase a copy of
                elementary OS, you're also supporting great projects like these.</p>
        </div>
    </div>
