    ...
    <dialog id="download-modal" class="dialog" aria-labelledby="download-modal-title">
      ...
      <div class="content-area">
        ...
        <div class="dialog-option">
          ...
          <a class="button download-link magnet x86" title="Torrent Magnet Link" href="<?php echo 'magnet:?xt=urn:btih:'.$config['release_magnet'].'&dn='.$config['release_filename']; ?>&tr=https%3A%2F%2Fashrise.com%3A443%2Fphoenix%2Fannounce&tr=udp%3A%2F%2Fopen.demonii.com%3A1337%2Fannounce&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80%2Fannounce&ws=<?php echo urlencode($download_link_x86.$config['release_filename']); ?>&xs=<?php echo urlencode($download_link_x86.$config['release_filename'].'.torrent'); ?>"><i class="fa fa-magnet"></i></a>
