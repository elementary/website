...
That wasn't too bad right? This is all that is required for elementary's build processes to create a .deb package from your project. You don't have to create a .deb file yourself. We'll set up more complicated packaging in the future. If you'd like you can always read [more about Debian packaging](https://www.debian.org/doc/debian-policy/).
