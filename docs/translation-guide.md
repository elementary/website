...
By default, you're only able to suggest translations. If you would like to get permissions to save translations, [join the translators Slack](https://join.slack.com/t/ele-l10n/shared_invite/zt-6afqz7ed-yyj4fsGHwwRX3XZq8Pdl~A) and message an admin your Weblate username and what language you want to translate.
