...
This section will cover the different types of windows available in elementary OS. Although each type of window is a bit different, think of them all as a subclass of a window. Unless otherwise stated, they all behave as an average window.
...
#### Next Page: [Dialogs](/docs/human-interface-guidelines/dialogs) {.text-right}