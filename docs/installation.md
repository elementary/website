...
```bash nohighlight
c6d33fd1db260d4e10e5ccbf38b09ba6287904c3388afa7db2de43736be7245d
```
...
```bash nohighlight
shasum -a 256 ~/Downloads/elementaryos-5.1-stable.20200706.iso
```
...
```bash nohighlight
shasum -a 256 <Path to the Downloaded Folder>/elementaryos-5.1-stable.20200706.iso
```
...
```bash nohighlight
sha256sum elementaryos-5.1-stable.20200706.iso
```
