...
<section id="support" class="grey">
    <div class="grid">
        ...
        <div class="half">
            ...
            <a class="button flat" href="https://github.com/elementary/website/blob/main/docs/learning-the-basics.md" target="_blank" rel="noopener">Learning the Basics Guide</a>
