...
<section id="desktop-development">
    <div class="grid">
        <div class="two-thirds">
            ...
            <p>This burndown chart shows our progress for the <a href="https://bugs.launchpad.net/elementary/+milestone/loki-rc1">Loki release</a>, which is our current development focus. Soon after that milestone is reached and Loki is released, this chart will be updated to reflect the next milestone. <a href="https://launchpad.net/elementaryos/+series" class="read-more">Learn More</a></p>
        </div>
        <div class="whole">
            <div class="charts">
