...
<section id="design">
    <div class="grid">
        <div class="two-thirds">
            <h2>Design</h2>
            <p class="text-center">Our design team turns ideas into clear issue reports and deliverable assets. Before diving in, it's recommended to read about our design workflow. <a class="read-more" href="https://docs.elementary.io/develop/writing-apps/code-style" target="_blank" rel="noopener">Learn More</a></p>
        </div>
    </div>
