...
return array(
    ...
    'covid_estimate' => 'Production is on schedule, but delays may still occur with fulfillment and shipping depending on the order, shipping method, and destination.',
);
